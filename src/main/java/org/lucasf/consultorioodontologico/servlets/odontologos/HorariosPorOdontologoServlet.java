...
@WebServlet("/odontologos/horarios")
public class HorariosPorOdontologoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (odontologo.isPresent()) {
                ...
                req.setAttribute("horarios", odontologo.get().getHorarios());
                req.getRequestDispatcher("/pages/odontologos/horariosOdontologo.jsp").forward(req, resp);
            } else {
